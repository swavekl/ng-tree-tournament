...
function DoubleEliminationTreeComponent_ng_container_8_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r1 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance(3);
    i0.ɵɵproperty("ngTemplateOutlet", ctx_r1.matchTemplate)("ngTemplateOutletContext", i0.ɵɵpureFunction1(2, _c0, match_r4));
} }
